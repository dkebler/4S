...
// TODO change this so if master or repo exists for location then uses those in options
// TODO change this so if location does not exist then just does deploy to single location, default is no location
            let options = {};
